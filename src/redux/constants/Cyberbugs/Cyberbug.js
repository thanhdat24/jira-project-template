...
export const REMOVE_USER_ASSIGNEES = "REMOVE_USER_ASSIGNEES";
...
export const SET_SUBMIT_CREATE_TASK = "SET_SUBMIT_CREATE_TAS";
//TASK TYPE
export const GET_ALL_TASK_TYPE_SAGA = "GET_ALL_TYPE_TASK_SAGA";
